                ...
                <div class="modal-content">
                    ...
                    <div class="addInsurance-ui">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <span class="input-group-btn">
                                        <div class="input-group date" data-provide="datepicker" data-date-autoclose="true" data-date-today-highlight="true">
                                            <input type="text" name="effectifeDate" 
                                                value={this.props.effectiveDateValue} 
                                                ref={this.props.effectiveDate} class="form-control"  
                                                style={{width: '330px'}} />
                            ...
                            <div class="modal-footer">
                                ...
                                <button type="button" class="btn btn-primary" onClick={this.props.updateInsurance} data-dismiss="modal">Update Insurance</button>
                            </div>
